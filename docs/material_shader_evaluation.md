...
2026-09-10。决定：限制采用光照前 RGB 染色表达式。P6.1 已按本页约束完成
Windows Studio／Player、导出和 Android 内置播放闭环，见
[作者与交付证据](validation/surface_authoring_2026-09-10.md)。以下保留逐步验证和失败
记录；历史段落中的“待接入”不是当前状态。完整材质语言、alpha／几何修改和 Apple
仍不在已支持范围，P6.2–P6.4 继续独立验证。
