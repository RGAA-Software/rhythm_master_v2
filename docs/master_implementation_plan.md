...
- `content/templates/*/manifest.json` 共 **20** 个，全部为 Advanced；简单和实验模板已按当前
  内容方向移出目录。20 个均为 `visual-review-pending`，不能当作用户验收数量。
- 语义组件 **30** 个；预设记录共 **209**，其中 119 条默认值记录被品质计数排除。
- 目标仍是 **40 个语义组件、120 个视觉独立合格预设、50 个高级合格作品**。
  当前没有建立正式品质验收总数；不能把 20 个候选或 209 条参数记录当作合格数量。
  达到候选数量和达到品质目标分别记账。
