...
这是一项 P8.5 增量，不代表所有性能、P8 或 P9 通过；下一项仍是连续改速相位。
...
| 2 | 连续改速的运动相位 | 先核对现有时间／状态节点与本地 TiXL 时间实现；复用可用能力，明确实时推进、暂停、定位、循环和离线导出契约，再接公开速度控件 | 改速不使画面瞬间回跳；暂停与显式定位语义清楚，实时／导出一致；独立时钟和音乐调制分离 |
