...
见 [事件合同及预算探针](local_events.md)。P2.2–P2.3 的图事件、定向重置、UI 观察、
组件和保存发布已交付；94 节点光幕协奏完成两端音乐/GPU 检查及 Android 界面回归。
P2.4 动作轨与录制进行中，尚不能把全部 P2 标记完成。
...
另记品质/平台未验证项；没有完成退出条件不标记交付。当前 P1–P9 均尚未按本文
新工作包验收；已有复用基础以第 2 节及历史记录为准。
