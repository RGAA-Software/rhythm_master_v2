...
2026-09-08 更新：上述为最初验证的历史状态。场景节点、基础 PBR、模型资产绑定和
音乐驱动三维作品已经接入；不要从“图和应用接入待完成”推断当前仍未实现。
后续材质/灯光/阴影、实例化和动画的当前顺序以
[渲染功能规划](rendering_capability_roadmap.md) 为准，本文保留 Godot 参考方向与复用边界。
