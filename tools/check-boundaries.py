...
def main():
    failures = []
    checked = 0
    for module in ("graph", "runtime", "parameters", "particles", "scene3d", "model_assets", "audio_analysis", "audio_playback", "cluster", "cluster_auth", "cluster_player", "foundation", "qr", "player_core", "editor_application", "rhythm_render"):
