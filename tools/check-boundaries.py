...
def main():
    failures = []
    checked = 0
    for module in ("graph", "runtime", "parameters", "performance", "particles", "scene3d", "shader_expression", "image_shader", "model_assets", "prepared_assets", "video_playback", "video_sources", "export_core", "audio_analysis", "audio_playback", "cluster", "cluster_auth", "cluster_player", "foundation", "qr", "player_core", "player_audio", "editor_application", "rhythm_render"):
