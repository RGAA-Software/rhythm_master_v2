...
add_custom_command(OUTPUT "${scene_shader_header}"
    ...
    DEPENDS "${PROJECT_SOURCE_DIR}/tools/build-render-shaders.py"
        ...
        "${PROJECT_SOURCE_DIR}/src/rhythm_render/shaders/scene_depth_prepass.sc"
...
if(BUILD_TESTING)
    ...
    add_custom_command(OUTPUT "${probe_shader_header}"
        ...
        DEPENDS "${PROJECT_SOURCE_DIR}/tools/build-render-shaders.py"
            ...
            "${PROJECT_SOURCE_DIR}/src/rhythm_render/shaders/transparency_probe_vertex.sc"
            "${PROJECT_SOURCE_DIR}/src/rhythm_render/shaders/transparency_probe_color.sc"
            "${PROJECT_SOURCE_DIR}/src/rhythm_render/shaders/transparency_probe_resolve.sc"
            "${PROJECT_SOURCE_DIR}/src/rhythm_render/shaders/transparency_probe_varying.def.sc"
            "${PROJECT_SOURCE_DIR}/src/rhythm_render/shaders/probe_varying.def.sc"
            "${RHYTHM_SHADERC}" ${render_shader_includes}
        VERBATIM)
    add_library(gpu_execution_probe STATIC
        "${PROJECT_SOURCE_DIR}/src/rhythm_render/tests/transparency_profile.cpp"
