...
Registry::Registry() {
    ...
    operators_ = {
            ...
            {"time.envelope",
             Operation::kTimeEnvelope,
             Type::kScalar,
             {{"time", Type::kScalar}},
             {{"clip_start", 0.0, 0, 86400},
              {"clip_duration", 4.0, 0.001, 86400},
              {"fade_in", 0.25, 0, 86400},
              {"fade_out", 0.25, 0, 86400},
              {"fade_shape", 1.0, 0, 1, {"curve.linear", "curve.smooth"}}}},
            {"scalar.map",
             Operation::kMap,
             Type::kScalar,
             {{"value", Type::kScalar}},
    ...
    operators_.push_back({"texture.noise",
                          ...
                          {{"phase", Type::kScalar, false},
                           {"offset_x", Type::kScalar, false},
                           {"offset_y", Type::kScalar, false}},
                          {{"noise_scale", 4.0, 0.25, 32},
                           {"phase", 0.0, 0, 4096},
                           {"offset_x", 0.0, -4096, 4096},
