...
void AppendSceneDescriptors(std::vector<OperatorDescriptor>& operators) {
    ...
    operators.push_back({"scene.instance",
                         ...
                         {{"sorting_offset", 0.0, -10000, 10000}}});
    ...
    operators.push_back({"scene.camera",
                         ...
                         Type::kCamera,
                         {{"eye_x", Type::kScalar, false},
                          {"eye_y", Type::kScalar, false},
                          {"eye_z", Type::kScalar, false},
                          {"target_x", Type::kScalar, false},
                          {"target_y", Type::kScalar, false},
                          {"target_z", Type::kScalar, false}},
